 ...
 */
public class DataInput6 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput6$Name());
      generators.add(new br.ufrj.cos.prisma.DataInput6$Id());
      return generators;
   }
