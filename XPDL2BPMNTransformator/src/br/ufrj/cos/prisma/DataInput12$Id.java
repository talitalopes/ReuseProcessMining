 ...
 */
@SuppressWarnings("unused")public class DataInput12$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput12$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput12$Id result = new DataInput12$Id();
    nl = null;
    return result;
  }
