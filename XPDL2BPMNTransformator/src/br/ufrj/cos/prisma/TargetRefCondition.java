 ...
 */
public class TargetRefCondition extends TextNodeGenerator{
   ...
   protected PropertyGenerator getTextGenerator(){
      return new br.ufrj.cos.prisma.TargetRefCondition$Text();
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional> -> dataInputAssociation -> TargetRef Condition";
   }
