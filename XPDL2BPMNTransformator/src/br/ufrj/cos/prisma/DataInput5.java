 ...
 */
public class DataInput5 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput5$Name());
      generators.add(new br.ufrj.cos.prisma.DataInput5$Id());
      return generators;
   }
