 ...
 */
public class ActivitysClassExtension extends IterationNodeGenerator{
   ...
   protected PropertyGenerator getConditionGenerator(){   
      return new br.ufrj.cos.prisma.ActivitysClassExtension$Condition();      
   }
   ...
   protected String getNodeName(){
      return "Activitys [Class Extension]";
   }
