 ...
 */
public class ExclusiveGateway extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.ExclusiveGateway$Name());
      generators.add(new br.ufrj.cos.prisma.ExclusiveGateway$GatewayDirection());
      generators.add(new br.ufrj.cos.prisma.ExclusiveGateway$Id());
      return generators;
   }
