 ...
 */
public class Taskdeclaration extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.Taskdeclaration$Name());
      generators.add(new br.ufrj.cos.prisma.Taskdeclaration$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Declaration] -> task <declaration>";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.IoSpecification3();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputAssociation7();
      childGenerators[2] = new br.ufrj.cos.prisma.DataInputAssociation8();
