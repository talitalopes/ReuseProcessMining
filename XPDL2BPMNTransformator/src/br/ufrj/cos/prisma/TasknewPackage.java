 ...
 */
public class TasknewPackage extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.TasknewPackage$Name());
      generators.add(new br.ufrj.cos.prisma.TasknewPackage$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [New package] -> task [new package]";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.IoSpecification6();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputAssociation12();
      childGenerators[2] = new br.ufrj.cos.prisma.DataInputAssociation13();
