 ...
 */
@SuppressWarnings("unused")public class DataInput8$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput8$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput8$Id result = new DataInput8$Id();
    nl = null;
    return result;
  }
