 ...
 */
@SuppressWarnings("unused")public class DataInput5$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput5$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput5$Id result = new DataInput5$Id();
    nl = null;
    return result;
  }
