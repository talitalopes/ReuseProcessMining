 ...
 */
public class InputSet4 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional> -> ioSpecification -> inputSet";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInputRefs9();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputRefs10();
