 ...
 */
public class To16 extends TextNodeGenerator{
   ...
   protected PropertyGenerator getTextGenerator(){
      return new br.ufrj.cos.prisma.To16$Text();
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Declaration] -> task <declaration> -> dataInputAssociation -> assignment -> to -> to";
   }
