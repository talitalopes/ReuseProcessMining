 ...
 */
public class FlowElement6 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement6$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement6$Name());
      return generators;
   }
