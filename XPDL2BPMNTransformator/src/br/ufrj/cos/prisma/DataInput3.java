 ...
 */
public class DataInput3 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput3$Name());
      generators.add(new br.ufrj.cos.prisma.DataInput3$Id());
      return generators;
   }
