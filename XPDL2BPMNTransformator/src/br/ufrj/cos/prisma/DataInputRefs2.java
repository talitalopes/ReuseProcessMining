 ...
 */
public class DataInputRefs2 extends TextNodeGenerator{
   ...
   protected PropertyGenerator getTextGenerator(){
      return new br.ufrj.cos.prisma.DataInputRefs2$Text();
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension] -> task <classExtension> -> ioSpecification -> inputSet -> dataInputRefs";
   }
