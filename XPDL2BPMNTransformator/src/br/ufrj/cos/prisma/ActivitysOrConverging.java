 ...
 */
public class ActivitysOrConverging extends IterationNodeGenerator{
   ...
   protected PropertyGenerator getConditionGenerator(){   
      return new br.ufrj.cos.prisma.ActivitysOrConverging$Condition();      
   }
   ...
   protected String getNodeName(){
      return "Activitys [OR - Converging]";
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [OR - Converging]";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TransitionRestrictions4();
