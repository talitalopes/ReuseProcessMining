 ...
 */
@SuppressWarnings("unused")public class TargetRef$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized TargetRef$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    TargetRef$Text result = new TargetRef$Text();
    nl = null;
    return result;
  }
