 ...
 */
public class ActivitysArtificialStart extends IterationNodeGenerator{
   ...
   protected PropertyGenerator getConditionGenerator(){   
      return new br.ufrj.cos.prisma.ActivitysArtificialStart$Condition();      
   }
   ...
   protected String getNodeName(){
      return "Activitys [Artificial Start]";
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Artificial Start]";
   }
