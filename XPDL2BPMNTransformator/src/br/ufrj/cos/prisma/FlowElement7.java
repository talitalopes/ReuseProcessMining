 ...
 */
public class FlowElement7 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement7$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement7$SourceRef());
      generators.add(new br.ufrj.cos.prisma.FlowElement7$TargetRef());
      return generators;
   }
