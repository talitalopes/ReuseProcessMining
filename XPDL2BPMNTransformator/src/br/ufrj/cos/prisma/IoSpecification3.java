 ...
 */
public class IoSpecification3 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Declaration] -> task <declaration> -> ioSpecification";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInput7();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInput8();
      childGenerators[2] = new br.ufrj.cos.prisma.InputSet3();
