 ...
 */
public class Assignment6 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Method Extension] -> task -> dataInputAssociation -> assignment";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.From11();
      childGenerators[1] = new br.ufrj.cos.prisma.To11();
