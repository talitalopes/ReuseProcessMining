 ...
 */
@SuppressWarnings("unused")public class To10$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To10$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To10$Text result = new To10$Text();
    nl = null;
    return result;
  }
