 ...
 */
public class InclusiveGateway2 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway2$Id());
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway2$Name());
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway2$GatewayDirection());
      return generators;
   }
