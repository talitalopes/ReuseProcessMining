 ...
 */
public class DataInputAssociation4 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment4();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef4();
