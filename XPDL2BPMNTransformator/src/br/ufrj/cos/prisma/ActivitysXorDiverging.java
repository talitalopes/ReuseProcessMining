 ...
 */
public class ActivitysXorDiverging extends IterationNodeGenerator{
   ...
   protected PropertyGenerator getConditionGenerator(){   
      return new br.ufrj.cos.prisma.ActivitysXorDiverging$Condition();      
   }
   ...
   protected String getNodeName(){
      return "Activitys [XOR - Diverging]";
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [XOR - Diverging]";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TransitionRestrictions3();
