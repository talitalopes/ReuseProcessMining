 ...
 */
public class IoSpecification6 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [New package] -> task [new package] -> ioSpecification";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInput12();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInput13();
      childGenerators[2] = new br.ufrj.cos.prisma.InputSet6();
