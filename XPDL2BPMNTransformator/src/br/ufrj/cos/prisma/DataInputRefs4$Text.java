 ...
 */
@SuppressWarnings("unused")public class DataInputRefs4$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInputRefs4$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInputRefs4$Text result = new DataInputRefs4$Text();
    nl = null;
    return result;
  }
