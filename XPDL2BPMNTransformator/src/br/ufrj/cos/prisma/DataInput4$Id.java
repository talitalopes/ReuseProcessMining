 ...
 */
@SuppressWarnings("unused")public class DataInput4$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput4$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput4$Id result = new DataInput4$Id();
    nl = null;
    return result;
  }
