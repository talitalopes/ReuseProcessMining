 ...
 */
public class DataInput4 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput4$Name());
      generators.add(new br.ufrj.cos.prisma.DataInput4$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Method Extension] -> task -> ioSpecification -> dataInput";
   }
