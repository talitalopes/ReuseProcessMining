 ...
 */
public class DataInputRefs11 extends TextNodeGenerator{
   ...
   protected PropertyGenerator getTextGenerator(){
      return new br.ufrj.cos.prisma.DataInputRefs11$Text();
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Import Model] -> task <importModel> -> ioSpecification -> inputSet -> dataInputRefs";
   }
