 ...
 */
public class TransitionRestrictions2 extends IterationNodeGenerator{
   ...
   protected String getIterationReference(){
      return "TransitionRestriction (xpdl2:TransitionRestriction_._type)";
   }
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [XOR - Converging] -> Transition Restrictions -> TransitionRestrictions";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Join();
