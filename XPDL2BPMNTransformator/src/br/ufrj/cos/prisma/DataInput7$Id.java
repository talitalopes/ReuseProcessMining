 ...
 */
@SuppressWarnings("unused")public class DataInput7$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput7$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput7$Id result = new DataInput7$Id();
    nl = null;
    return result;
  }
