 ...
 */
public class DataInputAssociation7 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment7();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef7();
