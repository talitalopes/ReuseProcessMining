...
public class DataInputAssociation3 extends XmlNodeGenerator{
   ...
   protected PropertyGenerator getElementTextGenerator(){
      ...
      return new br.ufrj.cos.prisma.DataInputAssociation3$TargetRef();
   }    
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension] -> task -> dataInputAssociation";
   }
