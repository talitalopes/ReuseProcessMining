 ...
 */
public class DataInput9 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput9$Id());
      generators.add(new br.ufrj.cos.prisma.DataInput9$Name());
      return generators;
   }
