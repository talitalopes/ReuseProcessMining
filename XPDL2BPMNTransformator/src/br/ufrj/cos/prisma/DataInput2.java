 ...
 */
public class DataInput2 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput2$Name());
      generators.add(new br.ufrj.cos.prisma.DataInput2$Id());
      return generators;
   }
