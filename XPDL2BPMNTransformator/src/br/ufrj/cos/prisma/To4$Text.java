 ...
 */
@SuppressWarnings("unused")public class To4$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To4$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To4$Text result = new To4$Text();
    nl = null;
    return result;
  }
