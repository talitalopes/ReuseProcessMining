 ...
 */
@SuppressWarnings("unused")public class To24$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To24$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To24$Text result = new To24$Text();
    nl = null;
    return result;
  }
