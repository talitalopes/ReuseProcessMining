 ...
 */
public class InputSet extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension] -> task <classExtension> -> ioSpecification -> inputSet";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInputRefs();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputRefs2();
      childGenerators[2] = new br.ufrj.cos.prisma.DataInputRefs3();
