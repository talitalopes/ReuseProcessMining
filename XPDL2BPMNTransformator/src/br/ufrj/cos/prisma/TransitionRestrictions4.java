 ...
 */
public class TransitionRestrictions4 extends IterationNodeGenerator{
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [OR - Converging] -> Transition Restrictions";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TransitionRestriction2();
