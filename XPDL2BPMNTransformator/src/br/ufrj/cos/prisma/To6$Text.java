 ...
 */
@SuppressWarnings("unused")public class To6$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To6$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To6$Text result = new To6$Text();
    nl = null;
    return result;
  }
