 ...
 */
public class DataInputAssociation9 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional> -> dataInputAssociation";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TargetRefCurrentAddress();
      childGenerators[1] = new br.ufrj.cos.prisma.Assignment9();
