 ...
 */
public class DataInputAssociation10 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TargetRefCondition();
      childGenerators[1] = new br.ufrj.cos.prisma.Assignment10();
