 ...
 */
public class DataInputAssociation12 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment12();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef10();
