 ...
 */
public class ExclusiveGatewaydiverging extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.ExclusiveGatewaydiverging$Id());
      generators.add(new br.ufrj.cos.prisma.ExclusiveGatewaydiverging$Name());
      generators.add(new br.ufrj.cos.prisma.ExclusiveGatewaydiverging$GatewayDirection());
      return generators;
   }
   ...
   protected String getNodeName(){
      return "exclusive gateway [diverging]";
   }
