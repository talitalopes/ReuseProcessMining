 ...
 */
public class Task3 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.Task3$Name());
      generators.add(new br.ufrj.cos.prisma.Task3$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension - Var declaration] -> task";
   }
