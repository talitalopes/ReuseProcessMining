 ...
 */
public class WorkflowProcesses extends IterationNodeGenerator{
   ...
   protected String getIterationReference(){
      return "WorkflowProcesses (xpdl2:WorkflowProcesses_._type)";
   }
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes";
   }
