 ...
 */
public class DataInputAssociation2 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension] -> task <classExtension> -> dataInputAssociation";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment2();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef2();
