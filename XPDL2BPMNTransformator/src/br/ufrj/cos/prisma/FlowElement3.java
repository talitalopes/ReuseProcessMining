 ...
 */
public class FlowElement3 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement3$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement3$SourceRef());
      generators.add(new br.ufrj.cos.prisma.FlowElement3$TargetRef());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Transitions -> Transitions -> flowElement";
   }
