 ...
 */
public class TransitionRestriction extends IterationNodeGenerator{
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [XOR - Diverging] -> Transition Restrictions -> TransitionRestriction";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Split();
