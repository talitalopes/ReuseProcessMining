 ...
 */
public class DataInputRefs13 extends TextNodeGenerator{
   ...
   protected PropertyGenerator getTextGenerator(){
      return new br.ufrj.cos.prisma.DataInputRefs13$Text();
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [New package] -> task [new package] -> ioSpecification -> inputSet -> dataInputRefs";
   }
