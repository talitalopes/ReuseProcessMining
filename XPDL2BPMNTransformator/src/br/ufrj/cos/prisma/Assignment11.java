 ...
 */
public class Assignment11 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Import Model] -> task <importModel> -> dataInputAssociation -> assignment";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.From21();
      childGenerators[1] = new br.ufrj.cos.prisma.To21();
