 ...
 */
public class DataInputAssociation11 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Import Model] -> task <importModel> -> dataInputAssociation";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment11();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef9();
