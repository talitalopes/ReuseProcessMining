 ...
 */
public class InclusiveGateway extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway$Id());
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway$Name());
      generators.add(new br.ufrj.cos.prisma.InclusiveGateway$GatewayDirection());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "DocumentRoot -> Workflow Processes -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [OR - Converging] -> Transition Restrictions -> TransitionRestriction -> Join -> inclusive gateway";
   }
