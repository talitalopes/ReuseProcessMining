...
public class FrameworkProcessMiningDialog extends Dialog {
	...
	public FrameworkProcessMiningDialog(Shell parentShell) {
		super(parentShell);
	}
	...
	public void loadModel(IFile model) {
		try {
			...
			setProcess((FrameworkProcess) eObject);
	...
	protected FrameworkProcess getProcess() {
		return process;
	}
	
	protected void setProcess(FrameworkProcess p) {
		this.process = p;
	}
