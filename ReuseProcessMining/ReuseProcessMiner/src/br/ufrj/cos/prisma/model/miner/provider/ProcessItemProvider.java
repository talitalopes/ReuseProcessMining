...
/**
 * This is the item provider adapter for a {@link br.ufrj.cos.prisma.model.miner.Process} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MinerPackage.Literals.PROCESS__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MinerPackage.Literals.PROCESS__ACTIVITIES);
			childrenFeatures.add(MinerPackage.Literals.PROCESS__INSTANCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MinerPackage.Literals.PROCESS__ACTIVITIES,
				 MinerFactory.eINSTANCE.createActivity()));

		newChildDescriptors.add
			(createChildParameter
				(MinerPackage.Literals.PROCESS__INSTANCES,
				 MinerFactory.eINSTANCE.createProcessInstance()));
	}
