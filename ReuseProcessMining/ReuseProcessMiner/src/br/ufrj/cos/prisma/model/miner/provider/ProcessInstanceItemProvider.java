...
/**
 * This is the item provider adapter for a {@link br.ufrj.cos.prisma.model.miner.ProcessInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessInstanceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MinerPackage.Literals.PROCESS_INSTANCE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MinerPackage.Literals.PROCESS_INSTANCE__EVENTS);
			childrenFeatures.add(MinerPackage.Literals.PROCESS_INSTANCE__COMMITS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MinerPackage.Literals.PROCESS_INSTANCE__EVENTS,
				 MinerFactory.eINSTANCE.createEvent()));

		newChildDescriptors.add
			(createChildParameter
				(MinerPackage.Literals.PROCESS_INSTANCE__COMMITS,
				 MinerFactory.eINSTANCE.createCommit()));
	}
