...
public class MinerFactoryImpl extends EFactoryImpl implements MinerFactory {
	...
	public static MinerFactory init() {
		try {
			MinerFactory theMinerFactory = (MinerFactory)EPackage.Registry.INSTANCE.getEFactory(MinerPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public br.ufrj.cos.prisma.model.miner.Process createProcess() {
