 ...
 */
@SuppressWarnings("unused")public class To2$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To2$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To2$Text result = new To2$Text();
    nl = null;
    return result;
  }
