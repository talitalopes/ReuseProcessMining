 ...
 */
public class FlowElement5 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement5$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement5$Name());
      return generators;
   }
