 ...
 */
@SuppressWarnings("unused")public class To8$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To8$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To8$Text result = new To8$Text();
    nl = null;
    return result;
  }
