 ...
 */
public class DataInput13 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput13$Id());
      generators.add(new br.ufrj.cos.prisma.DataInput13$Name());
      return generators;
   }
