 ...
 */
public class ActivitysClassExtensionVarDeclaration extends IterationNodeGenerator{
   ...
   protected PropertyGenerator getConditionGenerator(){   
      return new br.ufrj.cos.prisma.ActivitysClassExtensionVarDeclaration$Condition();      
   }
   ...
   protected String getNodeName(){
      return "Activitys [Class Extension - Var declaration]";
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension - Var declaration]";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Task3();
