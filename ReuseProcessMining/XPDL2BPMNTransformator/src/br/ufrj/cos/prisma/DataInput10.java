 ...
 */
public class DataInput10 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput10$Id());
      generators.add(new br.ufrj.cos.prisma.DataInput10$Name());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional> -> ioSpecification -> dataInput";
   }
