 ...
 */
@SuppressWarnings("unused")public class To28$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To28$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To28$Text result = new To28$Text();
    nl = null;
    return result;
  }
