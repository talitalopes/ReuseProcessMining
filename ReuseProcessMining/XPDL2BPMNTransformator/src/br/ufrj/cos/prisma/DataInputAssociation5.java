 ...
 */
public class DataInputAssociation5 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.TargetRef5();
      childGenerators[1] = new br.ufrj.cos.prisma.Assignment5();
