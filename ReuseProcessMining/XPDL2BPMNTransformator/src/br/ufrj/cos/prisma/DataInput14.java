 ...
 */
public class DataInput14 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput14$Id());
      generators.add(new br.ufrj.cos.prisma.DataInput14$Name());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "DocumentRoot -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Export Model] -> task <exportModel> -> ioSpecification -> dataInput";
   }
