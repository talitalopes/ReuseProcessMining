 ...
 */
public class InputSet3 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Declaration] -> task <declaration> -> ioSpecification -> inputSet";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInputRefs7();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputRefs8();
