 ...
 */
public class Transitions extends IterationNodeGenerator{
   ...
   protected String getIterationReference(){
      return "Transitions (xpdl2:Transitions_._type)";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Transitions2();
