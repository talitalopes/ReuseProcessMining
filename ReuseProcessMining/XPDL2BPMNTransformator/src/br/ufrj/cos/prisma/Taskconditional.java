 ...
 */
public class Taskconditional extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.Taskconditional$Name());
      generators.add(new br.ufrj.cos.prisma.Taskconditional$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional>";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.IoSpecification4();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputAssociation9();
      childGenerators[2] = new br.ufrj.cos.prisma.DataInputAssociation10();
