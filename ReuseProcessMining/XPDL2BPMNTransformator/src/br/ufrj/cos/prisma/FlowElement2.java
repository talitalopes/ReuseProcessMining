 ...
 */
public class FlowElement2 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement2$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement2$Name());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [End Event] -> flowElement";
   }
