 ...
 */
public class Assignment14 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "DocumentRoot -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Export Model] -> task <exportModel> -> dataInputAssociation -> assignment";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.From27();
      childGenerators[1] = new br.ufrj.cos.prisma.To27();
