 ...
 */
@SuppressWarnings("unused")public class DataInput11$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput11$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput11$Id result = new DataInput11$Id();
    nl = null;
    return result;
  }
