 ...
 */
public class DataInput7 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.DataInput7$Id());
      generators.add(new br.ufrj.cos.prisma.DataInput7$Name());
      return generators;
   }
