 ...
 */
@SuppressWarnings("unused")public class DataInput$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput$Id result = new DataInput$Id();
    nl = null;
    return result;
  }
