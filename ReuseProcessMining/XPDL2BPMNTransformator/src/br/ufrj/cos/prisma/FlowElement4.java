 ...
 */
public class FlowElement4 extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.FlowElement4$Id());
      generators.add(new br.ufrj.cos.prisma.FlowElement4$SourceRef());
      generators.add(new br.ufrj.cos.prisma.FlowElement4$TargetRef());
      return generators;
   }
