 ...
 */
public class DataInputAssociation14 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "DocumentRoot -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Export Model] -> task <exportModel> -> dataInputAssociation";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment14();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef12();
