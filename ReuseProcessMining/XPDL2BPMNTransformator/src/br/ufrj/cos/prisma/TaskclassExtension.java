 ...
 */
public class TaskclassExtension extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.TaskclassExtension$Name());
      generators.add(new br.ufrj.cos.prisma.TaskclassExtension$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Class Extension] -> task <classExtension>";
   }
