 ...
 */
public class IoSpecification7 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "DocumentRoot -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Export Model] -> task <exportModel> -> ioSpecification";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInput14();
      childGenerators[1] = new br.ufrj.cos.prisma.InputSet7();
