 ...
 */
public class TaskimportModel extends XmlNodeGenerator{
   ...
   protected Collection<PropertyGenerator> getAttributeValueGenerators(){
      ...
      generators.add(new br.ufrj.cos.prisma.TaskimportModel$Name());
      generators.add(new br.ufrj.cos.prisma.TaskimportModel$Id());
      return generators;
   }
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Import Model] -> task <importModel>";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.IoSpecification5();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInputAssociation11();
