 ...
 */
@SuppressWarnings("unused")public class To$Text extends PropertyGenerator
{

  protected static String nl;
  public static synchronized To$Text create(String lineSeparator)
  {
    nl = lineSeparator;
    To$Text result = new To$Text();
    nl = null;
    return result;
  }
