 ...
 */
public class IoSpecification4 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Conditional] -> task <conditional> -> ioSpecification";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInput9();
      childGenerators[1] = new br.ufrj.cos.prisma.DataInput10();
      childGenerators[2] = new br.ufrj.cos.prisma.InputSet4();
