...
public class XPDLPreprocessor {
	...
	public static void importModelAndCreatePackageTasks() {
		...
		importModelTask.name = "ImportModel_models/gef.uml";
		
		DocNode exportModelTask = new DocNode();
		exportModelTask.id = generateIdForElement();
		exportModelTask.name = "ExportModel_models/app.uml";
		...
		DocTransition importModel2ExportModel = new DocTransition();
		importModel2ExportModel.id = generateIdForElement();
		importModel2ExportModel.source = importModelTask.id;
		importModel2ExportModel.target = exportModelTask.id;

		DocTransition exportModel2PackageVarDeclaration = new DocTransition();
		exportModel2PackageVarDeclaration.id = generateIdForElement();
		exportModel2PackageVarDeclaration.source = exportModelTask.id;
		exportModel2PackageVarDeclaration.target = declarePackageVariableTask.id;
		...
		importModelTask.outgoing.add(importModel2ExportModel);

		exportModelTask.incoming.add(importModel2ExportModel);
		exportModelTask.outgoing.add(exportModel2PackageVarDeclaration);

		declarePackageVariableTask.incoming.add(exportModel2PackageVarDeclaration);
		...
		nodes.put(exportModelTask.id, exportModelTask);
