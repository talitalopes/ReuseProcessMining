 ...
 */
@SuppressWarnings("unused")public class DataInput3$Id extends PropertyGenerator
{

  protected static String nl;
  public static synchronized DataInput3$Id create(String lineSeparator)
  {
    nl = lineSeparator;
    DataInput3$Id result = new DataInput3$Id();
    nl = null;
    return result;
  }
