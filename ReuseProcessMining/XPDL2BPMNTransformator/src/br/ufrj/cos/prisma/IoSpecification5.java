 ...
 */
public class IoSpecification5 extends XmlNodeGenerator{
   ...
   protected String getNodePath(){
      return "Document Root -> WorkflowProcess -> WorkflowProcess -> process -> Activities -> Activitys [Import Model] -> task <importModel> -> ioSpecification";
   }
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.DataInput11();
      childGenerators[1] = new br.ufrj.cos.prisma.InputSet5();
