 ...
 */
public class DataInputAssociation3 extends XmlNodeGenerator{
   ...
   protected NodeGenerator[] getChildNodeGenerators(){
      ...
      childGenerators[0] = new br.ufrj.cos.prisma.Assignment3();
      childGenerators[1] = new br.ufrj.cos.prisma.TargetRef3();
