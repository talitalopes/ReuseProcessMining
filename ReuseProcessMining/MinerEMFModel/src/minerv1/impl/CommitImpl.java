...
public class CommitImpl extends MinimalEObjectImpl.Container implements Commit {
	...
	protected EClass eStaticClass() {
		return Minerv1Package.Literals.COMMIT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Minerv1Package.COMMIT__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Minerv1Package.COMMIT__NAME, oldName, name));
	}
